...
"""
import math
terms=int(input("I will estimate pi. How many terms should I use?") #100
decimals=int(input("How many decimal places should I use in the result?") #7
e=1.0/sum([(4((-1.0)**k)/2*k +1)for k in range(0,terms)])
print("The approximate value of pi is {0}".format(round(e,decimals))) #3.1315929